...
```
The data was cleaned by analyzing outliers below 0% for each carbohydrate type  and either eliminating them if they were outliers compared to other samples of the same variety or by reclassifying the carbohydrate as 0% since < 0% is not biologically possible. 
